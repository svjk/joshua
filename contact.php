...
<section class="engine"><a href="https://mobirise.info/j"></a></section><section class="mbr-section form4 cid-rm0unb6mMM" id="form4-23">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <div class="google-map"><iframe src="https://www.google.com/maps/embed?pb=!1m16!1m12!1m3!1d3887.0707806326686!2d77.63330046430492!3d13.031164567095507!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!2m1!1s%23184%2C+Hennur+Cross%2C+Near+Indian+Academy+College%2COff+Ring+Road%2C+Bengaluru-560043+Karnataka%2C+India.!5e0!3m2!1sen!2sin!4v1553854037228!5m2!1sen!2sin" frameborder="0" style="border:0" allowfullscreen></iframe></div>
            </div>
            <div class="col-md-6">
                ...
                <div data-form-type="formoid">
                    <!--Formbuilder Form-->
                    <form action="contact_process.php" method="POST" class="mbr-form form-with-styler" data-form-title="Mobirise Form"><input type="hidden" name="email" data-form-email="true" value="BAtew3w9rpSVf3mzmBd7PK0/3wycmWuF0dmdsMmbvQ6VPEBwx8u9zFlPpDftenUOKbHvmZCQReJsu4gqlRS09ZAe+vqpbvCI0hIMjVTEcYoytDNZa4Xod4ggP8n3ZEBi">
                        <div class="dragArea row">
                            <div class="col-md-6  form-group" data-for="name">
                                <input type="text" name="name" placeholder="Your Name" data-form-field="Name" required="required" class="form-control input display-7" id="name-form4-23">
                            </div>
                            <div class="col-md-6  form-group" data-for="phone">
                                <input type="text" name="phone" placeholder="Phone" data-form-field="Phone" required="required" class="form-control input display-7" id="phone-form4-23">
                            </div>
                            ...
                            <div data-for="message" class="col-md-12  form-group">
                                <textarea name="message" placeholder="Message" data-form-field="Message" class="form-control input display-7" id="message-form4-23"></textarea>
                            </div>
...
<section class="features13 cid-rm0ta6a02W" id="features13-1w">
    <div class="container">
            ...
            <div class="card col-12 col-md-6 align-center col-lg-4">
                <div class="card-wrap">
                    ...
                    <div class="card-box">
                        ...
                        <p class="mbr-text mbr-fonts-style mbr-white display-7">
                            080-41722223<br />9741264243<br />9731663600
                        </p>
                    </div>
                </div>
            </div>
            <div class="card col-12 col-md-6 align-center col-lg-4">
                <div class="card-wrap">
                    ...
                    <div class="card-box">
                        ...
                        <p class="mbr-text mbr-fonts-style mbr-white display-7" style="margin-top:30px;margin-bottom:30px">
                            svj.kendra@gmail.com
                        </p>
                    </div>
                </div>
            </div>    
